...
// llamar la funciones 
   include("conec.php"); 
    ...
    $sql1="select codigo_solicitud, dia_solicitud, tipo_servicio, fk_identidad_nino, fk_cedula_ninera, fk_cedula_acudiente from solicitud where codigo_solicitud='$codigo'";
...
?> 
 ...
 <center><div class="btn-group" role="group" aria-label="Basic example" style="margin-bottom: 20px; border: solid 0.5px white ;">
  <button type="button" OnClick="location.href='solicitud_eliminar.html'" class="btn btn-secondary">Eliminar</button>
  <button type="button" OnClick="location.href='valida_perfil_solicitud.php'" class="btn btn-primary">Volver</button>
