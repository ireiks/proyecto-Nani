...
<body> 
<legend><center> Cuenta niñera </center></legend>
    <br>
    <center><img src="imagenes/nani1.png" style="width: 15%"></center>
    <br>
		<form action="valida_ninera.php" method="POST"> 
		...
		<tr>
		    <td colspan="2" align="center">
				<a href="http://localhost:8080/menunani/ninera1.php" class="btn btn-success">Registrarse</a>
			</td> 
		</tr> 
	</table> 
	</form> 
