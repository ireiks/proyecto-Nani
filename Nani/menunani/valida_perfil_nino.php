...
<legend><center> Cuenta acudiente </center></legend>
    ...
    <br> 
		<form action="perfil_nino.php" method="POST"> 
		...
		<tr> 
			...
			<td>
				<input type="Text" name="identidad" size="8" maxlength="50">
			</td> 
		</tr> 
		<tr>
		    <td colspan="2" align="center">
 <center><div class="btn-group" role="group" aria-label="Basic example" style="margin-bottom: 20px; border: solid 0.5px white ;">
  <button type="submit" OnClick="location.href='perfil_nino.php'" class="btn btn-primary">Editar</button>
